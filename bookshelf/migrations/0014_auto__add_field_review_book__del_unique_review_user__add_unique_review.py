...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'bookshelf_review', ['user_id'])

        # Adding field 'Review.book'
        db.add_column(u'bookshelf_review', 'book',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['bookshelf.Book']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Review.book'
        db.delete_column(u'bookshelf_review', 'book_id')

        # Adding unique constraint on 'Review', fields ['user']
        db.create_unique(u'bookshelf_review', ['user_id'])
    ...
    models = {
        ...
        u'bookshelf.editor': {
            'Meta': {'ordering': "['name']", 'object_name': 'Editor'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
        ...
        u'bookshelf.readerlevel': {
            'Meta': {'ordering': "['name']", 'object_name': 'ReaderLevel'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
