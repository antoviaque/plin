...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookshelf_book', 'isbn',
                      self.gf('django.db.models.fields.CharField')(default=9788563144263, max_length=13),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.isbn'
        db.delete_column(u'bookshelf_book', 'isbn')
