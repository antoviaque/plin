...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookshelf_book', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='na', unique_with=(), max_length=50, populate_from='title'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.slug'
        db.delete_column(u'bookshelf_book', 'slug')
