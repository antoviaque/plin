...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookshelf_book', 'cover',
                      self.gf('django.db.models.fields.files.ImageField')(default='covers/blank.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.cover'
        db.delete_column(u'bookshelf_book', 'cover')
